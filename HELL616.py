...
def install_pipenv():
    os.system("pipenv run pip3 install pipenv")
...
def split():
    pyautogui.hotkey("ctrl", "shift", "d")
    time.sleep(1)
    pyautogui.typewrite("pipenv run python3 HELL616.py\n")
    pyautogui.hotkey("ctrl", "shift", "d")
    time.sleep(1)
    pyautogui.typewrite("pipenv run python3 HELL616.py\n")
    pyautogui.hotkey("ctrl", "shift", "d")
...
def multi_mode():
    pyautogui.hotkey("ctrl", "shift", "d")
    time.sleep(0.01)
    pyautogui.typewrite("pipenv run python3 HELL616.py +1\n")
...
def multi_multi():
    ...
    for i in range(num_xterms):
        ...
        if position == "center":
            geometry = "80x24+0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL616.py; HELL616.main_menu()'\" &"
            )
            time.sleep(0.1)
...
def ddos_play():
    ...
    for i in range(num_xterms):
        ...
        if position == "center":
            geometry = "80x24+0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL616; HELL616.ddos_install()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
            ...
            geometry = "80x24-0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL616; HELL616.sql_attack()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
...
def what_now2():
    ...
    print
    print(" ")
    print("\033[91m1\033[0m)\033[90m\033[0m NEW SEARCH")
    print("\033[91m2\033[0m)\033[90m\033[0m Go Back to \033[41mHell\033[0m")
    print("\033[91m3\033[0m)\033[90m \033[31mGAHHH! IT BURNS!!!\033[0m")
...
def repo():
    ...
    if choice == "3":
        ...
        os.chdir("fsociety")
        os.system("pipenv run pip3 install fsociety")
        os.system("pipenv run pip3 install --upgrade fsociety")
        os.system("pipenv run pip3 install -e '.[dev]'")
...
def tfiles():
    ...
    footer()
    choice = input("\033[97mSelect an option: ").lower()
    if choice == "1":
        clear_screen()
...
def breach():
    ...
    footer()
    choice = input("\033[0mSelect an option: ").lower()
    if choice == "1":
        osintio()
        time.sleep(1)
        tsar()
...
def ficial():
    ...
    print("\033[91m3\033[0m)\033[90m \033[0mInteractive WebScrape ai\033[0m")
...
def duckbot():
    ...
    time.sleep(2)
    os.system("curl -sSL https://raw.githubusercontent.com/aandrew-me/tgpt/main/install | bash -s /usr/local/bin")
    subprocess.run(["pipenv", "run", "tgpt", "--provider", "isou", "-i"])
    wah()
...
def main_menu():
    ...
    print(
        "       \033[91m17\033[0m)\033[90m Info Finder              \033[91m99\033[0m) \033[41mEXIT\033[0m"
    )
    print(" ")
    choice = input("\033[97mSelect an option: ").lower()
    ...
    if choice == "1":
        ...
        os.system("git clone https://github.com/Thr0wAway-n0w/ParseSnips.git")
        os.chdir("ParseSnips")
        os.system("git fetch")
        os.system("git pull")
        os.system("sudo chmod +x 1of2.py")
        os.system("sudo chmod +x 2of2.py")
        subprocess.run(["pipenv", "run", "python3", "1of2.py"])
        what_now2()
    elif choice == "99":
        clear_screen()
        ascii_banner()
...
def miku():
    clear_screen()
    ascii_banner()
    print(colored("STARTING MIKUMIKU BEAM! VISIT LOCAL HOST ADDRESS IN WEB BROWSER WHEN PROMPTED", "red", attrs=["reverse", "blink", "bold"]))
    time.sleep(3)
    os.system("git clone https://github.com/sammwyy/mikumikubeam.git")
    os.chdir("mikumikubeam")
...
def kaboom():
    ...
    print(
        "                 ♛ \033[91m19\033[0m)\033[90m BitBrute                      ♛ \033[91m20\033[0m)\033[90m Disclose 🪬            ♛ \033[92m$$$\033[0m)\033[91m Battosai\033[0m"
    )
    print(
        "                 ♛ \033[91mBomb\033[0m)\033[90m Squad                          \033[91mHEX\033[0m)\033[90m HExHTTP                \033[94mMiku\033[0m)\033[97m MikuMiku Beam"
    )
    print(
        "                 ♛ \033[91mDSV\033[0m)\033[90m DSVenom                                                                                                                      "
    )
    footer()
    choice = input("\033[0mSelect an option: ").lower()
    if choice == "1":
        ...
        os.system("pipenv run pip3 install GeoIP")
        os.system("pipenv run pip3 install python-geoip")
        os.system("pipenv run pip3 install pygeoip")
        os.system("pipenv run pip3 install requests")
        os.system("pipenv run pip3 install pycurl")
        os.system("pipenv run pip3 install whois")
        os.system("pipenv run pip3 install scapy-python3")
        ...
        change()
        os.system("pipenv run pip3 install dronesploit")
        ...
        time.sleep(3)
        kaboom()
    elif choice == "battosai":
        print(" ")
        print("\033[96mM.A.N. Slayer ")
        print(" ")
        print("", end="", flush=True)
        for char in " \033[91mBattosai is a 'Mnemonic-Authentication-Navigator'coded by Dongle. It generates valid Legacy Bitcoin Wallet Nmemonic phrases with intentially decreased entropy to replicate the javascript vulnerabily impacting all Bitcoin Wallets created between 2010 and 2013. It then checks the value of the wallet dervived from the mnemonic. The balance prints in Battosai's mouth. Whatever Battosai Finds is Yours to Take.":
            print(char, end="", flush=True)
            time.sleep(0.04)
        time.sleep(3)
        kaboom()
    elif choice == "$$$":
        os.system("git clone https://github.com/Thr0wAway-n0w/Multitude.git")
        os.chdir("Multitude")
        subprocess.run(["pipenv", "run", "python3", "shmerms.py"])
        what_now()
    elif choice == "hex":
        os.system("git clone https://github.com/c0dejump/HExHTTP.git")
        os.chdir("HExHTTP")
        os.system("pipenv run python3 -m pip install -r requirements.txt")
        clear_screen()
        print("")
        print("http URL you want to inspect")
        urn = input("http URL: ")
        subprocess.run(["pipenv", "run", "python3", "hexhttp.py", "-u", urn])
        what_now()
    elif choice == "hexhttp":
        print(" ")
        print("\033[96mHExHTTP")
        print(" ")
        print("", end="", flush=True)
        for char in " \033[91mHExHTTP is a tool designed to perform tests on HTTP headers and analyze the results to identify vulnerabilities and interesting behaviors.":
            print(char, end="", flush=True)
            time.sleep(0.04)
        time.sleep(3)
        kaboom()
        ...
        print(" ")
        print("\033[96mBomb-Squad,Ransomware Recovery")
        print(" ")
        print("", end="", flush=True)
        for char in " \033[91mA List of Tools ready to save your Shit ":
            print(char, end="", flush=True)
            time.sleep(0.04)
        time.sleep(3)
        kaboom()
        ...
        print(" ")
        print("\033[96m AntiVirus Bypass Tool")
        print("Utilizing a combination of advanced techniques to manipulate and disguise payloads, DSViper delivers a robust solution for achieving undetected access. ")
        print("", end="", flush=True)
        for char in " \033[91m":
            print(char, end="", flush=True)
            time.sleep(0.04)
        ...
        print("")
        os.system("git clone https://github.com/dagowda/DSViper.git")
        os.chdir("DSViper")
        os.system("sudo chmod +x install_dependencies.sh")
        os.system("./install_dependencies.sh")
        os.system("python3 DSViper.py")
        what_now()
    elif choice == "bomb":
        print("")
        os.system("git clone https://github.com/Thr0wAway-now/BombSquad")
        os.chdir("BombSquad")
        os.system("python3 BombSquad.py")
        what_now()
    elif choice == "miku":
        miku()
    elif choice == "back":
...
def frameworks_menu():
    ...
    if choice == "1":
        change()
        install_command = "pipenv run pip3 install git+https://github.com/saeeddhqan/maryam.git"
