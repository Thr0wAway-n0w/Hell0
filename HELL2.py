...
if option == "1":
    ...
    print(
        colored(
            "TYPE/RUN THE COMMAND 'pipenv shell'. THEN 'cd' TO THE FILES LOCATION and RUN HELL2.py AGAIN!",
            "red",
            attrs=["reverse", "blink", "bold"],
        )
    )
...
def gahhh():
    ...
    clear_screen()
    time.sleep(0.5)
    print(colored("NOW LEAVING HELL2...", "red", attrs=["reverse", "blink", "bold"]))
    time.sleep(2)
    exit()
    ...
    for i in range(num_xterms):
        process = subprocess.Popen(
            [
                ...
                "python3",
                "-c",
                f"import HELL2; HELL2.ddos_install(); {command}",
            ]
        )
...
def isend_command_to_xterms():
    ...
    for i in range(num_xterms):
        process = subprocess.Popen(
            ["xterm", "-e", "pipenv", "run", "python3", "-c", f"import HELL2; HELL2.kicks(); {command}"]
        )
        processes.append(process)
...
def split():
    pyautogui.hotkey("ctrl", "shift", "d")
    time.sleep(1)
    pyautogui.typewrite("pipenv run python3 HELL2.py\n")
    pyautogui.hotkey("ctrl", "shift", "d")
    time.sleep(1)
    pyautogui.typewrite("pipenv run python3 HELL2.py\n")
    pyautogui.hotkey("ctrl", "shift", "d")
...
def multi_mode():
    pyautogui.hotkey("ctrl", "shift", "d")
    time.sleep(0.01)
    pyautogui.typewrite("pipenv run python3 HELL2.py +1\n")
...
def multi_multi():
    ...
    for i in range(num_xterms):
        ...
        if position == "center":
            geometry = "80x24+0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.main_menu()'\" &"
            )
            time.sleep(0.1)
...
def ddos_play():
    ...
    for i in range(num_xterms):
        ...
        if position == "center":
            geometry = "80x24+0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.ddos_install()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
            ...
            geometry = "80x24-0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.sql_attack()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
            ...
            geometry = "80x24+0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.simba_menu()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
            ...
            geometry = "80x24+0-0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.prox()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
            ...
            geometry = "80x24-0-0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.cyber()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
...
def wi_die():
    ...
    for i in range(num_xterms):
        ...
        if position == "center":
            geometry = "80x24+0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.wlan()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
            ...
            geometry = "80x24-0+0"
            os.system(
                f"xterm -geometry {geometry} -hold -e \"pipenv run python3 -c 'import HELL2; HELL2.ipp()'\" &"
            )
            pyautogui.typewrite("1\n")
            time.sleep(0.03)
            pyautogui.typewrite("3\n")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if function_name == 'network':
            networks_menu()
        elif function_name == 'username':
            menu()
        elif function_name == 'usernames':
            menu()
        elif function_name == 'email':
            emails_menu()
        elif function_name == 'networks':
            networks_menu()
        elif function_name == 'emails':
            emails_menu()
        elif function_name == 'phone':
            emails_menu()
        elif function_name == 'phones':
            emails_menu()
        elif function_name == 'framework':
            frameworks_menu()
        elif function_name == 'frameworks':
            frameworks_menu()
        elif function_name == 'unclassified':
            unclassified_menu()
        elif function_name == 'camera':
            cameras_menu()
        elif function_name == 'cameras':
            cameras_menu()
        elif function_name == 'geo':
            geo_menu()
        elif function_name == 'deadman':
            deadman()
        elif function_name == 'tool':
            repo()
        elif function_name == 'tools':
            repo()
        elif function_name == 'forbidden':
            forbidden()
        elif function_name == 'knowledge':
            forbidden()
        elif function_name == 'multi':
            multi_menu()
        elif function_name == 'dante':
            kaboom()
        elif function_name == 'dantes':
            kaboom()
        elif function_name == 'deep':
            deep_dark()
        elif function_name == 'dark':
            deep_dark()
